<template>
    <nav aria-label="Page navigation example">
        <ul class="inline-flex -space-x-px text-base h-10">
            ...
            <li>
                <a href="#" aria-current="page" class="flex items-center justify-center px-4 h-10 leading-tight text-white bg-red-600 border border-gray-300 hover:bg-red-700 hover:text-white dark:bg-red-800 dark:border-gray-700 dark:text-white">1</a>
            </li>
            <li>
